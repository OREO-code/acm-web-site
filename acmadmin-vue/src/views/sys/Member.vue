...
export default {
  ...
  methods:{
    ...
    page(){
      const _this = this
      this.$axios.get("/getYear").then(res=>{
        console.log(res.data.data)
        _this.queryFrom.yearList = res.data.data;
      })
      this.$axios.get("/getCollege").then(res=>{
        console.log(res.data.data)
        _this.queryFrom.collegeList = res.data.data;
      })
      console.log("==============")
      console.log(_this.queryFrom)
      // this.$axios.post("/members",_this.From).then(res=>{
      //   console.log(res)
